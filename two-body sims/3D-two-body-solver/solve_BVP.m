function output_BVP = solve_BVP(q0,mu0,qf,tf,params,s)
...
%   output_BVP.q : 8x8xn matrix containing the solution for q(t) 
%              (e.g., output.q(:,:,10) is the solution for q(t(10))
%   output_BVP.mu : nx12 vector containing the solution for mu(t)
%   output_BVP.M : 12x12xn matrix containting Jacobian of mu(t) with respect to mu(0)
...
while i <= params.nmax 
    ...
    % Solve IVP
    output_IVP = solve_IVP(q0,mu0,tf,params,s);
